                                        ...
                                        <tr class="odd gradeX">
                                           ...
                                           <!--  <td class="center">
                                            ...
                                            <td class="center">
                                                 ...
                                                 <a href="modmismacotas.php?cod=<?php echo $row[15]; ?> & nom=<?php echo $row[16].' '.$row[17];?>" <button type="button" ><span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
                                            </td>
