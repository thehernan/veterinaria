...
date_default_timezone_set('America/Lima');
		...
		if ( empty($_POST['txtape']) || empty($_POST['txtnom']) || empty($_POST['txtdomi']) || empty($_POST['txtdni']) || empty($_POST['txtema'])){  
			...
			require_once ("../config/conexion.php");//Contiene funcion que conecta a la base de datos
                ...
                if($dni==$dnibs){
                 ...
                 $sql = "INSERT INTO cliente (nombre, apellidos,direccion,telf1,telf2,ruc,dni,email,activo,f_creacion,paginaweb,clave,nivel)
       VALUES('".$nom."','".$ape."','".$domi."','".$t1."','".$t2."','".$ruc."','".$dni."','".$ema."','".$estado."','".$Fecharegistro."','".$web."','".base64_encode($clave)."','2');";
