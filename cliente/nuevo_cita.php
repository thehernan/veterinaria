                                 ...
                                 <form  method="post" name="guardacita" id="guardacita">
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="txtmasc" id="txtmasc" readonly placeholder="Cliente" required class="form-control">
                                            ...
                                            <input type="datetime-local" name="txtf" id="txtf" placeholder="Fecha" required class="form-control">
                                                ...
                                                <div class="form-group">
                                                     <label class="radio-inline">
                                                         <input type="radio" id="noreserva" name="optradio" checked="true" value="1">Normal                 
                                                    </label>
                                                      <label class="radio-inline">
                                                          <input type="radio" id="reserva" name="optradio" value="2">Reservar Cita                 
                                                    </label>
