            ...
            <div id="page-inner">
                ...
                <div class="col-lg-12">
                   ...
                   <div class="col-lg-12">
                                            ...
                                            <label>Dueño</label>
                                            <input type="hidden" id="txtid" name="txtid"  value="<?php echo $_SESSION['idregistro']; ?>" class="form-control">
                                            <input type="text" name="txtclie" id="txtclie" value="<?php echo $_SESSION['user_name']; ?>" readonly placeholder="Datos del dueño" required class="form-control  input-sm">
