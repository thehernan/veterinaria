                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">
                                                ...
                                                <button class='btn btn-primary' onclick="agregarprod(<?php echo $producto->getId().",'".$producto->getCodigo()."','".$producto->getDescripcion()."','".$op."'" ?>)"><i class='fa fa-plus fa-fw'></i></button>
