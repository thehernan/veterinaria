...
//				$ruc = strip_tags($_POST["txtruc"],ENT_QUOTES); 
                ...
                if($dni==$dnibs){
                 ...
                 $sql = "INSERT INTO cliente (nombre, direccion,telf1,telf2,dni,email,activo,f_creacion,paginaweb,clave,nivel,id_tipo_documento,distrito,provincia)
       VALUES('".$nom."','".$domi."','".$t1."','".$t2."','".$dni."','".$ema."','".$estado."','".$Fecharegistro."','".$web."','".base64_encode($clave)."','2','".$tipodoc."','".$dis."','".$pro."');";
