...
//				$ruc = strip_tags($_POST["txtruc"],ENT_QUOTES); 
				...
				//$registro=$_SESSION['user_id'];
                 ...
                 $sql = "UPDATE  cliente SET nombre ='".$nom."',direccion='".$domi."',telf1='".$t1."',telf2='".$t2."',dni='".$dni."',email='".$ema."',paginaweb='".$web."',id_tipo_documento='".$tipodoc."' ,distrito='".$dis."',provincia='".$pro."'
                       where id_cliente ='".$id."'";
