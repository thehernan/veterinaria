...
if (isset($_POST['textcod'])){$codigo=$_POST['textcod'];}
if (isset($_POST['textprod'])){$descripcion=$_POST['textprod'];}
if (isset($_POST['textlote'])){$lote=$_POST['textlote'];}
if (isset($_POST['textcant'])){$cantidad=$_POST['textcant'];}

if (isset($_POST['textprecio'])){$precio_venta=$_POST['textprecio'];}
if (isset($_POST['txtfecha'])){$fechaf=$_POST['txtfecha'];}
if (isset($_POST['txtfechaexp'])){$fechaexp=$_POST['txtfechaexp'];}
if (isset($_POST['txtnlote'])){$nlote=$_POST['txtnlote'];}
if (isset($_POST['txtrs'])){$rs=$_POST['txtrs'];}
...
{   
//    echo $precio_venta;
    $temp->setIdproducto ($id);
    $temp->setCantidad($cantidad);
    $temp->setPrecio($precio_venta);
    ...
    if($lote==1){
        ...
        $temp->setFechaf($fechaf);
        $temp->setFechaex($fechaexp);
        $temp->setNlote($nlote);
        $temp->setRs($rs);
