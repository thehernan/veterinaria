                ...
                <table class="table table-bordered table-dark table-hover" id="dataTables-example">
                    <thead>
                        <tr>
                            ...
                            <th>T.P Costo</th>
                            <th>T.P Venta</th>
                            <th>Utilidad |<a target="_blank" href="./pdf/documentos/utilidad_doc.php?des=<?php echo $desde; ?>&& hasta=<?php echo $hasta; ?> && area=<?php echo  $area?>"> <img src="./img/pdf.png" width="30px" >  </a></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php 
                        ...
                        preciocompra/prod.factor * det.cantidad as tcosto ,det.cantidad*det.precio as tventa,(det.cantidad*det.precio)-(preciocompra/prod.factor * det.cantidad) as utilidad
