		...
		if ( empty($_POST['txtape']) || empty($_POST['txtnom']) || empty($_POST['txtdomi']) || empty($_POST['txtdni']) || empty($_POST['txtce']) || empty($_POST['txtpro'])  ){ 
            ...
            require_once ("../config/conexion.php");//Contiene funcion que conecta a la base de datos
                ...
                if($dni==$dnibs){
                 ...
                 $sql = "INSERT INTO doctor (nombre,apellidos,direccion,dni,celular,profesion,fecharegistro,email,clave,activo,nivel)
       VALUES('".$nom."','".$ape."','".$domi."','".$dni."','".$cel."','".$pro."','".$Fecharegistro."','".$ema."','". base64_encode($clave)."','0','3');";
//                 echo $sql;
