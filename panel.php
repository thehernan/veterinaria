...
<div class="row">
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        <div class="panel panel-primary text-center no-boder bg-color-green">
                            <div class="panel-body">
                                <a href="lista_clientes.php"><i class="fa fa-bar-chart-o fa-5x"></i></a>
                                <h3><?php $año= date('Y');
      ...
      inner join cliente cl on cl.id_cliente=m.id_cliente where c.atendido=0 order by inicio_normal DESC";
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        <div class="panel panel-primary text-center no-boder bg-color-brown">
                            <div class="panel-body">
                                <a href="lista_admin.php">  <i class="fa fa-users fa-5x"></i></a>
                                <h3><?php $año= date('Y');
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        <div class="panel panel-primary text-center no-boder bg-color-brown">
                            <div class="panel-body">
                                <a href="lista_doctor.php"><i class="fa fa-users fa-5x"></i></a>
                                <h3><?php $año= date('Y');
                                    $sql="SELECT count(*)as num  FROM doctor ;";
                                    $ejecute=mysqli_query($conexion,$sql);
                                    $row=mysqli_fetch_assoc($ejecute);
                                    echo $row['num'];
                                ?>
