...
$login = new Login();
echo '<script> console.log("'.$login->isUserLoggedIn().'")</script>';
// ... ask if we are logged in here:
if ($login->isUserLoggedIn() == true) {
    // the user is logged in. you can do whatever you want here.
    // for demonstration purposes, we simply show the "you are logged in" view.
//   he|ader("location:panel.php");
...
<head>
  ...
  <title>SISTEMA VETERINARIA | Login</title>
...
<body>
 ...
 <div class="container">
     <div class="row">
      <div class="col-md-4  col-md-offset-1 "> <!-- col-md-offset-4 -->
        <div class="login-panel panel panel-default fondo " data-stellar-background-ratio="0.5">
            <br>
