                                ...
                                <table class="table table-striped table-bordered table-hover datatable" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><button  cod='<?php echo $row['id_cliente'];?>' dni='<?php echo $row['dni'];?>' ruc='<?php echo $row['ruc'];?>'  class="btn btn-success asignarcliente" type="button" >+</button></td>
                                        </tr>
                                    <?php }  ?>
                                    </tbody>
                                </table>
