                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover datatable" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        on p.id_producto = l.id_producto where  p.lote = 0 and  categoria ='Baños'" ;
                                        //echo $sql;
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><input type="text" name="precio" id="precio" value='<?= number_format($row[14]/$row[16],2); ?>' > </td>
                                            <td class="center"><input type="text" name="cantidad" id="cantidad" value="1" readonly="readonly"></td>
                                            <td class="center">
