                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="panel-body">
                                 <form  method="post" name="modidoctor" id="modidoctor">
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            <label>Celular</label>
                                            <input type="text" name="txtce" id="txtce" placeholder="Celular"  class="form-control">
                                        </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="text" name="txtpro" id="txtpro" placeholder="Profesión"  class="form-control">
                                        </div>  
