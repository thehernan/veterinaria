                    ...
                    <div class="modal-dialog modal-lg tamano" >
                         ...
                         <?php include ('modal/moduscarcliente.php');?>
                                ...
                                <!--fin -->
                                        ...
                                        <div class="form-group">
                                            <label>Especie</label>
                                            <input  type="text" name="txtes" id="txtes"  required placeholder="Especie" class="form-control  input-sm">
                                           
                                        </div>
                                
                                        <div class="form-group">
                                            <label>Raza</label>
                                            <input type="text" name="txtra" id="txtra" required placeholder="Raza" class="form-control  input-sm">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input  type="file" name="txtfoto" id="txtfoto"  accept="image/*"  class="form-control  input-sm">
                                             ...
                                             <div class="form-group">
                                                 <label>Señas</label>
                                                 <input type="text" name="txtseñas" id="txtseñas" class="form-control  input-sm" placeholder="señas">
                                             </div>   
