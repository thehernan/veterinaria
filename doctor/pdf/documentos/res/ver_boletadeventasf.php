...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
  ...
  <tr>
    ...
    <td width="26%" rowspan="3" style="width: 29%; border-radius: 16px 16px 16px 16px;
...
border: 2px solid #000000">
    ...
    <td width="1%" rowspan="3" style="width: 2%;">&nbsp;</td>
  </tr>
  <tr> 
    <td><i>Cliente : </i></td>
...
<table align="center"  border="0" style="width: 100%; color: #34495e;">
  <tr>
    <td width="23%" rowspan="1" style="width: 13%;"><img style="width: 100px;"  src="../../img/1537673723_logo.jpg" alt="Logo" /></td>
    <td colspan="2" align="center" style="color: #34495e;font-size:12px;text-align:center; width:56%;"><span style="color: #34495e;font-size:14px;font-weight:bold"><?php echo get_row('perfil','nombre_empresa', 'id_perfil', 1);?></span> <br />
      <?php echo get_row('perfil','direccion', 'id_perfil', 1)."<br>"."-". get_row('perfil','ciudad', 'id_perfil', 1)." ".get_row('perfil','estado', 'id_perfil', 1);?><br />
      Teléfono: <?php echo get_row('perfil','telefono', 'id_perfil', 1);?></td>
    <td width="26%" rowspan="3" style="width: 29%; border-radius: 16px 16px 16px 16px;
-moz-border-radius: 16px 16px 16px 16px;
-webkit-border-radius: 16px 16px 16px 16px;
border: 2px solid #000000">&nbsp; R.U.C. N° 20529927704 <br />
      <h4> &nbsp; BOLETA DE VENTA</h4>
  ...
  <tr>
    <td><i>Tipo Movimiento:</i></td>
    <td colspan="3" align="left"><?php echo $tipomovimiento; ?> __ <i>Fecha :
