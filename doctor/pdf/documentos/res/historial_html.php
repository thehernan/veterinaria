...
while ($row=mysqli_fetch_array($sql))
	...
	$consulta=$row['consultacosto'];
	$tratamiento=$row['tratamientocosto'];
	$analisis=$row['analisiscosto'];
	$vacuna=$row['vacunacosto'];
	$servicios=$row['serviciosveterinariocosto'];
	$cirugia=$row['cirujiacosto'];
	$internado=$row['internadocosto'];

	$totals=$consulta+$tratamiento+$analisis+$vacuna+$servicios+$cirugia+$internado;
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;">
      ...
      <tr>
        <th class='midnight-blue' style="width:12 %;text-align:center">CONSULTA S/.</th>
        <th class='midnight-blue' style="width: 15%">TRATAMIENTO <span class="midnight-blue" style="width:15 %;text-align:center">S/.</span></th>
        <th class='midnight-blue' style="width: 10%">ANALISIS <span class="midnight-blue" style="width:15 %;text-align:center">S/.</span></th>
        <th class='midnight-blue' style="width: 10%"><span class="midnight-blue" style="width: 15%;text-align: right">VACUNA <span class="midnight-blue" style="width:15 %;text-align:center">S/.</span></span></th>
        <th class='midnight-blue' style="width: 12%">SERVICIOS<span class="midnight-blue" style="width:15 %;text-align:center"> S/.</span></th>
        <th class='midnight-blue' style="width: 10%">CIRUJIA<span class="midnight-blue" style="width:15 %;text-align:center"> S/.</span></th>
        <th class='midnight-blue' style="width: 13%">INTERNADO<span class="midnight-blue" style="width:15 %;text-align:center"> S/.</span></th>
        <th class='midnight-blue' style="width: 10%;text-align: right">TOTAL <span class="midnight-blue" style="width:15 %;text-align:center">S/.</span></th>
      </tr>
      <tr>
        <td width="7%"  style="width: 15%; text-align: center"><?php echo $consulta; ?></td>
        <td width="9%"  style="width: 19%; text-align: left"><?php echo $tratamiento;?></td>
        <td width="27%"  style="width:10%; text-align: left"><?php echo $analisis;?></td>
        <td width="18%"  style="width: 10%; text-align: left"><?php echo $vacuna;?></td>
        <td width="18%"  style="width: 10%; text-align: left"><?php echo $servicios;?></td>
         <td width="18%"  style="width: 10%; text-align: left"><?php echo $cirugia;?></td>
          <td width="18%"  style="width: 13%; text-align: left"><?php echo $internado;?></td>
        <td width="5%"  style="width: 10%; text-align: right"><?php  echo number_format($totals,2);?></td>
      </tr>
    </table>
...
$nums=1;
$sumador_total=0;
$sql2=mysqli_query($conexion, "SELECT *,d.precio as pre,d.cantidad as can  FROM detalle_historial d
inner join producto p on p.id_producto=d.id_producto where d.id_historial='".$idh."';");
 
while ($row1=mysqli_fetch_array($sql2))
	{
	$medicamento=$row1['descripcion'];	
	
	 		$precio_vent=$row1['pre'];
...
<tr>
    ...
    <td align="left" class='text-right' style="width: 20%;" >TOTAL MEDICAMENTO S/ </td>
