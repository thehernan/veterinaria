                        ...
                        <div class="panel-body">
                            <form action="" method="post">
                                <div class="form-group">
                                    <label class="text-danger h3">Seleccione Paciente</label><hr>
                                    <input type="hidden" id="txtid" name="txtid" class="form-control">
                                    <input type="text" name="txtmasc" id="txtmasc" readonly placeholder="Nombre del paciente" required class="form-control"><br>
