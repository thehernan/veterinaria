...
<body>
 ...
 <?php include('nav.php'); ?>  
        ...
        <div id="page-wrapper" >
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default" >
                        <div class="panel-heading">
                              <?php echo $clien=$_GET['nom']; ?> - Mis Mascotas - <a href="lista_clientes.php"class="btn btn-info"><i class="glyphicon glyphicon-arrow-left"></i> atras</a>
                        </div>
          ...
          <div class="panel-body"id='panelmascota' >
              <?php $idm=$_GET['cod']; ?>
               <?php 
              ...
              <div class="caption">
                ...
                <h6>
                       <?php 
                            ...
                            echo '<strong style="color:#FF0000";>Estraviado : '.$row['extraviado'].'</strong> '; 
                            echo '<strong>DVI: </strong>'.$row['codigodvi'];
                            echo '<strong> Señas: '.$row['señas'].'</strong>';

                       ?> 
                </h6>
                </p>
                <p
                    <button type="button" onclick="momascota(<?php echo $row['id_mascota']; ?>)" class="btn btn-primary" data-toggle="modal" data-target=".bd-example-modal-lg"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button>
