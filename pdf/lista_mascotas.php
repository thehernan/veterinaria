                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php echo $row[16].' - ' .$row[17]; ?></td>
                                             <td class="center">
                                                 <a target="_blank" href="pdf/documentos/historial.php?idc=<?php echo $row[14];?> & idm=<?php echo $row[0];?>">Imprimir</a>
                                            </td>
                                             <td class="center">
                                            ...
                                            <td class="center">
                                                 ...
                                                 <a href="modmismacotas.php?cod=<?php echo $row[14]; ?> & nom=<?php echo $row[15].' '.$row[16];?>" <button type="button" ><span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
                                            </td>
