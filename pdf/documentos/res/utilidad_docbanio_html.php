...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;">
	     <tr>
           <td colspan="5" class='midnight-blue' style="width:50%;">INGRESOS</td>
        </tr>
	        ...
	        <th class='midnight-blue' style="width: 40%"><span class="midnight-blue" style="width: 15%;text-align: right">NOMBRE / RAZÓN SOCIAL</span></th>
                <th class='midnight-blue' style="width: 10%;text-align:center">CODIGO</th>
	        <th class='midnight-blue' style="width: 30%"><span class="midnight-blue" style="width: 15%;text-align: right">DESCRIPCIÓN</span></th>
	    
            <th class='midnight-blue' style="width: 10%;text-align: center">TOTAL</th>
          </tr>
	      <?php
$nums=1;
$s=1;
...
det.precio  
 ...
 on doc.id_cliente=c.id_cliente  inner JOIN detalle as det on doc.id_documento=det.id_documento
	...
	?>
	      <tr>
	        ...
	        <td width="27%"  style="width: 40%; text-align: left"><?php echo $vc .'<br>';?></td>
                <td width="18%"  style="width: 10%; text-align: center"><?php echo $cod .'<br>';?></td>
	        <td width="18%"  style="width: 30%; text-align: left"><?php echo $d .'<br>';?></td>
	
              <td width="11%"  style="width: 10%; text-align: center"><?php echo number_format($precio, 2, ".", ".") .'<br>';?></td>
          </tr>
	      <?php 
...
?>
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
      <tr>
        ...
        <th width="10%" class='midnight-blue' style="width: 25%;text-align: right"><span class="midnight-blue" style="width:5%;"><span class="midnight-blue" style="width:12%;"><span class="midnight-blue" style="width:5%;"><?php echo number_format($tutilidad,2); ?></span></span></span></th>
